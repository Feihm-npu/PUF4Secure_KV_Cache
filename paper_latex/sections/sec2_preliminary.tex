...
\textbf{G5: Practicality.} The construction should identify a vectorizable path and expose its overhead. We measure end-to-end prototype serving overhead for the PyTorch wrapper and leave fused-kernel overhead to future implementation work.
